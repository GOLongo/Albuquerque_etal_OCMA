...
coral_occ2050_UCsPI_crop <- crop(coral_occ2050, extent(UCsPI_fdrl))
plot(coral_occ2050_UCsPI_crop)

# Converting MPAs' shapefile to raster
coral_occ2050_UCsPI_fdrl_ras <- rasterize(UCsPI_fdrl, coral_occ2050, getCover=TRUE)
coral_occ2050_UCsPI_fdrl_ras[coral_occ2050_UCsPI_fdrl_ras==0] <- NA

#Extracting and Saving occurrence probability values within MPAs
coral_occ2050_UCsPI_fdrl_mask <- mask(coral_occ2050, coral_occ2050_UCsPI_fdrl_ras, filename = "dados_sig/2050/UCsPI/UCsPI_fdrl/coral_occ2050_UCsPI_fdrl_mask.asc", overwrite = T)

plot(coral_occ2050_UCsPI_fdrl_mask)
#----------
...
(gph_UCSPI_fdrl_2050 <- ggplot      (coral_occ2050_UCsPI_fdrl_values_df,
  aes(coral_occ2050_UCsPI_fdrl_values)) + 
