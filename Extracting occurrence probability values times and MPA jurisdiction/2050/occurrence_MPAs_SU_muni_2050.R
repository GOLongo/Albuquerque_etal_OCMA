...
coral_occ2050_UCsUS_crop <- crop(coral_occ2050, extent(UCsUS_muni))
plot(coral_occ2050_UCsUS_crop)

# Converting MPAs' shapefile to raster
coral_occ2050_UCsUS_muni_ras <- rasterize(UCsUS_muni, coral_occ2050, getCover=TRUE)
coral_occ2050_UCsUS_muni_ras[coral_occ2050_UCsUS_muni_ras==0] <- NA

#Extracting and Saving occurrence probability values within MPAs
coral_occ2050_UCsUS_muni_mask <- mask(coral_occ2050, coral_occ2050_UCsUS_muni_ras, filename = "dados_sig/2050/UCsUS/UCsUs_muni/coral_occ2050_UCsUS_muni_mask.asc", overwrite = T)

plot(coral_occ2050_UCsUS_muni_mask)
#----------
...
gph_UCSUS_muni_2050 <- ggplot(coral_occ2050_UCsUS_muni_values_df, 
                         aes(coral_occ2050_UCsUS_muni_values)) + 
...
gph_UCSUS_fdrl_2050 /gph_UCSUS_estd_2050 / gph_UCSUS_muni_2050
