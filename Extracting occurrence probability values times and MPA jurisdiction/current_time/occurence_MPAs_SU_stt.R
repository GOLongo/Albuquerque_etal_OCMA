...
coral_occ2020_UCsUS_crop <- crop(coral_occ2020, extent(UCsUS_estd))
plot(coral_occ2020_UCsUS_crop)

# Converting MPAs' shapefile to raster
coral_occ2020_UCsUS_estd_ras <- rasterize(UCsUS_estd, coral_occ2020, getCover=TRUE)
coral_occ2020_UCsUS_estd_ras[coral_occ2020_UCsUS_estd_ras==0] <- NA

#Extracting and Saving occurrence probability values within MPAs
coral_occ2020_UCsUS_estd_mask <- mask(coral_occ2020, coral_occ2020_UCsUS_estd_ras, filename = "dados_sig/ucs_novas/AMPs_us/ucs_us_estd/coral_occ2020_UCsUS_estd_mask.asc")

plot(coral_occ2020_UCsUS_estd_mask)
#----------
...
#length(na.omit(coral_occ2020_UCsUS_values)) # Aqui, s? para visualizar o numero de USxels em UCsUS
...
gph_UCSUS_estd <- ggplot(coral_occ2020_UCsUS_estd_values_df, 
       aes(coral_occ2020_UCsUS_estd_values)) + 
