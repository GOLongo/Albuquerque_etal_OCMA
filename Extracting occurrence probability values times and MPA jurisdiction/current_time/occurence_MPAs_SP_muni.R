...
coral_occ2020_UCsPI_crop <- crop(coral_occ2020, extent(UCsPI_muni))
plot(coral_occ2020_UCsPI_crop)

# Converting MPAs' shapefile to raster
coral_occ2020_UCsPI_muni_ras <- rasterize(UCsPI_muni, coral_occ2020, getCover=TRUE)
coral_occ2020_UCsPI_muni_ras[coral_occ2020_UCsPI_muni_ras==0] <- NA

#Extracting and Saving occurrence probability values within MPAs
coral_occ2020_UCsPI_muni_mask <- mask(coral_occ2020, coral_occ2020_UCsPI_muni_ras, filename = "dados_sig/ucs_novas/AMPs_pi/ucs_pi_muni/coral_occ2020_UCsPI_muni_mask.asc")

plot(coral_occ2020_UCsPI_muni_mask)
#----------
...
(gph_UCSPI_muni <- ggplot(coral_occ2020_UCsPI_muni_values_df, 
       aes(coral_occ2020_UCsPI_muni_values)) + 
...
gph_UCSPI_fdrl / gph_UCSPI_estd / gph_UCSPI_muni
