...
coral_occ2020_UCsPI_crop <- crop(coral_occ2020, extent(UCsPI_estd))
plot(coral_occ2020_UCsPI_crop)

# Converting MPAs' shapefile to raster
coral_occ2020_UCsPI_estd_ras <- rasterize(UCsPI_estd, coral_occ2020, getCover=TRUE)
coral_occ2020_UCsPI_estd_ras[coral_occ2020_UCsPI_estd_ras==0] <- NA

#Extracting and Saving occurrence probability values within MPAs
coral_occ2020_UCsPI_estd_mask <- mask(coral_occ2020, coral_occ2020_UCsPI_estd_ras, filename = "dados_sig/ucs_novas/AMPs_pi/ucs_pi_estd/coral_occ2020_UCsPI_estd_mask.asc")

plot(coral_occ2020_UCsPI_estd_mask)
#----------
...
(gph_UCSPI_estd <- ggplot(coral_occ2020_UCsPI_estd_values_df, 
       aes(coral_occ2020_UCsPI_estd_values)) + 
...
#gph_UCSPI_estd + scale_y_continuous(labels = scales::label_percent(scale = 1))
