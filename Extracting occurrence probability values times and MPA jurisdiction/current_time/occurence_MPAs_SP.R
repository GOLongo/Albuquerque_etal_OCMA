...
# strict protected MPAs in current time          #
##################################################
...
coral_occ2020_UCsPI_crop <- crop(coral_occ2020, extent(UCsPI))
plot(coral_occ2020_UCsPI_crop)

# Converting MPAs' shapefile to raster
coral_occ2020_UCsPI_ras <- rasterize(UCsPI, coral_occ2020, getCover=TRUE)
coral_occ2020_UCsPI_ras[coral_occ2020_UCsPI_ras==0] <- NA

#Extracting and Saving occurrence probability values within MPAs
coral_occ2020_UCsPI_mask <- mask(coral_occ2020,
                                 coral_occ2020_UCsPI_ras,
                                filename = "dados_sig/ucs_novas/AMPs_pi/coral_occ2020_UCsPI_mask_ras.asc")

plot(coral_occ2020_UCsPI_mask)
#----------
...
gph_UCsPI <- ggplot(coral_occ2020_UCsPI_values_df, 
...
#plot of distribution values for the entire coast 
coral_occ2020_values_df <- as.data.frame(coral_occ2020_values)
hist(coral_occ2020_values)



(gph_tot <- ggplot(coral_occ2020_values_df, 
                  aes(coral_occ2020_values)) + 
  geom_histogram(bins = 15,
                 fill = "#bdbdbd", 
                 colour = "#636363") + 
  geom_vline(xintercept = 0.4069, 
