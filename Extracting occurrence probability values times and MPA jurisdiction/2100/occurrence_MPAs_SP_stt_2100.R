...
# strict protected  MPAs under state             # 
...
UCsPI_estd  <- st_read(dsn = "dados_sig/ucs_novas/AMPs_pi/ucs_pi_estd/ucs_pi_estd.shp", layer = "ucs_pi_estd", crs = 4236)
...
coral_occ2100_UCsPI_crop <- crop(coral_occ2100, extent(UCsPI_estd))
plot(coral_occ2100_UCsPI_crop)

# Converting MPAs' shapefile to raster
coral_occ2100_UCsPI_estd_ras <- rasterize(UCsPI_estd, coral_occ2100, getCover=TRUE)
coral_occ2100_UCsPI_estd_ras[coral_occ2100_UCsPI_estd_ras==0] <- NA

#Extracting and Saving occurrence probability values within MPAs
coral_occ2100_UCsPI_estd_mask <- mask(coral_occ2100, coral_occ2100_UCsPI_estd_ras, filename = "dados_sig/2100/UCsPI/UCsPI_estd/coral_occ2100_UCsPI_estd_mask.asc", overwrite = T)

plot(coral_occ2100_UCsPI_estd_mask)
#----------
...
gph_UCSPI_estd_2100 <- ggplot(coral_occ2100_UCsPI_estd_values_df, 
                              aes(coral_occ2100_UCsPI_estd_values)) + 
...
gph_UCSPI_fdrl_2100 / gph_UCSPI_estd_2100 
