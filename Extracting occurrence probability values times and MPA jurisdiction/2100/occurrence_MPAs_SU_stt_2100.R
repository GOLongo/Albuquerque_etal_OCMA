...
# sustainable use  MPAs under state              # 
...
coral_occ2100_UCsUS_crop <- crop(coral_occ2100, extent(UCsUS_estd))
plot(coral_occ2100_UCsUS_crop)

# Converting MPAs' shapefile to raster
coral_occ2100_UCsUS_estd_ras <- rasterize(UCsUS_estd, coral_occ2100, getCover=TRUE)
coral_occ2100_UCsUS_estd_ras[coral_occ2100_UCsUS_estd_ras==0] <- NA

#Extracting and Saving occurrence probability values within MPAs
coral_occ2100_UCsUS_estd_mask <- mask(coral_occ2100, coral_occ2100_UCsUS_estd_ras, filename = "dados_sig/2100/UCsUS/UCsUS_estd/coral_occ2100_UCsUS_estd_mask.asc", overwrite = T)

plot(coral_occ2100_UCsUS_estd_mask)
#----------
...
gph_UCSUS_estd_2100 <- ggplot(coral_occ2100_UCsUS_estd_values_df, 
                              aes(coral_occ2100_UCsUS_estd_values)) + 
